...
import { Check, Palette, RotateCcw, Type, Maximize2 } from 'lucide-react';
      ...
      <CardContent className="flex flex-col gap-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-[11px] text-muted-foreground">
            Changes the FAB button and primary accents
          </p>
        </section>
            ...
            {(Object.keys(FONT_SIZE_LABELS) as FontSize[]).map((key) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex-1 rounded-lg border-2 px-3 py-2 text-sm font-medium transition-all duration-150',
                    isActive
            ...
            {(Object.keys(FONT_STYLE_LABELS) as FontStyle[]).map((key) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex-1 rounded-lg border-2 px-3 py-2.5 text-left transition-all duration-150',
                    isActive
